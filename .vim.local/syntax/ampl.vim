...
syntax keyword amplStatement            _var _con _varname _conname
...
syntax match   amplDotSuffix            "\.body\|\.dinit[0]\|\.[lu]\?dual\|\.[lu]bs"
...
syntax keyword amplBuiltinOption        solver log_file auxfiles
...
if version >= 508 || !exists("did_ampl_syntax_inits")
    ...
    HiLink amplBuiltinOption        Function
